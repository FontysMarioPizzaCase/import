...
import me.fontys.semester4.dominos.configuration.data.catalog.pizzawithingredients.extract.Extractor;
import me.fontys.semester4.dominos.configuration.data.catalog.pizzawithingredients.load.Loader;
import me.fontys.semester4.dominos.configuration.data.catalog.pizzawithingredients.transform.Transformer;
...
public class Importer {
    ...
    @Autowired
    public Importer(@Qualifier("pizzaWithIngredients") Resource[] resources,
