...
import me.fontys.semester4.dominos.configuration.data.catalog.prepare.clean.DataCleaner;
import me.fontys.semester4.dominos.configuration.data.catalog.prepare.extract.DataExtractor;
import me.fontys.semester4.dominos.configuration.data.catalog.prepare.validate.DataValidator;
...
public abstract class DataPrepper<RawT, CleanT> implements HasExtendedLogger {
